...
MISPLACED_SOUND = pygame.mixer.Sound("misplaced.wav")
INCORRECT_SOUND = pygame.mixer.Sound("incorrect.wav")
UNUSED_SOUND = pygame.mixer.Sound("unused.wav")
SCREENREADER_OFF_SOUND = pygame.mixer.Sound("screenreader_off.wav")
SCREENREADER_ON_SOUND = pygame.mixer.Sound("screenreader_on.wav")
